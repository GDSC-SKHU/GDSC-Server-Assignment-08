...
public class MemberService {
    ...
    public TokenDTO login(String memberId, String password) {
        // 1. 사용자로부터 받아온 ID/PW 를 기반으로 Authentication 객체 생성
        // 이때 authentication 객체는 인증 여부를 확인하는 authenticated 값이 false (인증 전)
        ...
        return tokenDTO;    // 로그인 성공 시 tokenDTO에 제대로 값이 들어감
    }
}